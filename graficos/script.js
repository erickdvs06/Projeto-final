...
function exibirFraseInformativa(url) {
    ...
    <p>Além disso, <strong>F1</strong> com <span>${valores[2]}</span> pontos, também é um dos jogos de destaque. Por outro lado, matérias como <strong>Fortnite</strong> com <span>${valores[3]}</span> pontos, <strong>Minecraft</strong> com <span>${valores[1]}</span> pontos e especialmente <strong>Samba</strong> com <span>${valores[5]}</span> pontos despertam menos meu interesse.</p>
    `;
    }
